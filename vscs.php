...
function vscs_admin_init() {
    ...
    add_settings_section( 'vscs-section', __( 'Description', 'very-simple-custom-style' ), 'vscs_section_callback', 'vscs' );
...
function vscs_section_callback() {
    echo __( 'On this page you can add Custom Style (CSS) to change the layout of your theme or plugin.', 'very-simple-custom-style' ); 
}
...
<div class="wrap"> 
	...
	<?php submit_button(__('Save Style', 'very-simple-custom-style')); ?>
	</form>
